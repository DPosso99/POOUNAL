...
public class Cap4EjercicioResueltoN15 {
    ...
    if ((pesoA == pesoB) && (pesoA == pesoC)) { /*Aqui comparamos el peso de la esfera A con la B y C. 
    Si son iguales, la esfera D seria la diferente.*/
      System.out.println("La esfera D es la diferente ");
    } else {
      if ((pesoA == pesoB) && (pesoA == pesoD)) { /*Aqui comparamos el peso de la esfera A con la B y D. 
    Si son iguales, la esfera C seria la diferente.*/ 
        System.out.println("La esfera C es la diferente ");
            if (pesoD > pesoA){
                System.out.println("la esfera D es la de mayor peso"); /*para saber si es de mayor o 
      ...
      } else if ((pesoA == pesoB) && (pesoA == pesoD)) { /*Aqui comparamos el peso de la esfera A con la B y D. 
    Si son iguales, la esfera C seria la diferente.*/
        System.out.println("La esfera C es la diferente ");
            if (pesoC > pesoA){
      ...
      } else if ((pesoA == pesoC) && (pesoA == pesoD)) { /*Aqui comparamos el peso de la esfera A con la C y D. 
    Si son iguales, la esfera B seria la diferente.*/
        ...
        System.out.println("La esfera A es la diferente " ); /*Aqui usamos el condicional else y entraria en esta instacia
